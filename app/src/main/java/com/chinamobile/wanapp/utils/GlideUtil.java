...
public class GlideUtil {
    ...
    public static void loadImageView(Context mContext, String path, ImageView mImageView) {
        ...
        Glide.with(mContext).load(path).placeholder(R.mipmap.default_image).diskCacheStrategy(DiskCacheStrategy.RESULT).error(R.mipmap.default_image).into(mImageView);
    }
