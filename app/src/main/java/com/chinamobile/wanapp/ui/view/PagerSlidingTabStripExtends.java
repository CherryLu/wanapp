...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
	...
	public PagerSlidingTabStripExtends(Context context, AttributeSet attrs, int defStyle) {
		...
		tabSelectedTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabSelectedTextSize,
				tabSelectedTextSize);
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				// when selected this tab, set tab's selected color and size
